...
export default function ProductCard({ image, title, price, onClick }) {
  return (
    <div className="bg-gray-150 w-1/3 mt-2 mb-10 flex justify-center items-center">
      <div className="w-80 px-10 bg-white rounded py-10 transform transition-all hover:translate-y-2">
        ...
        <div className="flex justify-between">
          <button
            onClick={onClick}
            className="bg-blue-400 px-4 py-1 h-30 w-30 hover:bg-violet-600 text-white rounded mt-3 ml-1 "
          >
            Add to cart
          </button>
